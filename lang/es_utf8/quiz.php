...
$string['configshufflequestions'] = 'Si habilita esta opción, el orden de preguntas se barajará aleatoriamente cada vez que el estudiante intenta resolver el cuestionario.';
$string['configshufflewithin'] = 'Si habilita esta opción, las partes que componen las preguntas individuales se barajarán aleatoriamente cada vez que un estudiante intenta resolver este cuestionario, en el supuesto de que la opción esté también habilitada en los ajustes de la pregunta.';
...
$string['createcategoryfornewrandomquestion'] = 'Crear una categoría de preguntas para la nueva pregunta aleatoria';
...
$string['noview'] = 'Al usuario autentificado no se le permite ver este cuestionario.';
...
$string['shufflequestionsselected'] = '* Las preguntas aparecerán en orden aleatorio. Como resultado, el botón Volver a ordenar las preguntas se ha desactivado. Puede cambiar esto en $a.';
$string['shufflequestionsx'] = 'Barajar preguntas: $a';
