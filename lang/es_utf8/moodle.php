...
$string['admin'] = 'Admin';
$string['adminbookmarks'] = 'Marcadores del administrador';
...
$string['assignstudentsnote'] = 'Nota: Es posible que no sea necesario utilizar esta página dado que los estudiantes se pueden matricular por sí mismos en este curso.';
$string['assignstudentspass'] = 'Todo lo que necesita es notificar a sus estudiantes la contraseña de acceso para este curso, que en este caso es: $a';
$string['assignteachers'] = 'Asignar profesores';
$string['authenticateduser'] = 'Usuario autenticado';
$string['authenticateduserdescription'] = 'Todos los usuarios autenticados.';
...
$string['backtocourselisting'] = 'Regresar a listado de cursos';
$string['backtopageyouwereon'] = 'Regresar a la página de procedencia';
...
$string['backupmetacoursehelp'] = 'Si se activa, la información de metacurso (matriculaciones heredadas) se incluirá en las copias de seguridad automatizadas';
...
$string['backupschedulehelp'] = 'Decida en qué días de la semana se realizarán las copias de seguridad automatizadas';
...
$string['blockseditoff'] = 'Edición de bloques';
$string['blocksediton'] = 'No edición de bloques';
...
$string['chooseauthmethod'] = 'Elegir plugin de autenticación';
...
$string['coresystem'] = 'Núcleo del sistema';
$string['cost'] = 'Coste';
...
$string['courseenrolend'] = 'Fin de matriculación en el curso';
$string['courseenrolenddate'] = 'Fecha final de matriculación en el curso';
$string['courseenrolstart'] = 'Comienzo de matriculación en el curso';
...
$string['coursehelpenrollable'] = 'Los estudiantes pueden matricularse a sí mismos utilizando el \'plugin\' de matriculación interactiva por defecto';
$string['coursehelpenrolmentkey'] = 'Si se activa, los usuarios necesitarán esta clave para matricularse en el curso.';
$string['coursehelpenrolmentplugins'] = '\'plugin\' de matriculación interactiva por defecto.';
$string['coursehelpexpirynotifystudents'] = 'Si se ha especificado la duración de la matriculación, este ajuste determina si los estudiantes recibirán una notificación por email cuando estén a punto de darse de baja del curso.';
$string['coursehelpexpirythreshold'] = 'Si se ha especificado la duración de la matriculación, este ajuste determina el númreo de días en que se enviará una notificación antes de que los estudiantes sean dados de baja del curso.';
...
$string['coursehelpmetacourse'] = 'Definir el curso como metacurso. Un metacurso toma las matriculaciones (y otras asignaciones de rol) de uno o más cursos \'hijos\'.';
...
$string['coursehelpnotify'] = 'Si se ha especificado la duración de la matriculación, este ajuste determina si los profesores recibirán una notificación por email cuando un estudiante esté a punto de ser dado de baja del curso.';
...
$string['deleteallratings'] = 'Eliminar todas las clasificaciones';
...
$string['donotclickcontinue'] = 'No haga clic en el siguiente enlace de continuación ;-)';
$string['down'] = 'Abajo';
...
$string['editorhelptopics'] = 'Temas de ayuda del editor.';
...
$string['enrolledincoursenotrole'] = 'Error de matriculación en \"$a->course\" as \"$a->role\"';
...
$string['enrolmentkeyfromguest'] = 'Este curso requiere una \'clave de matriculación\' - como invitado<br />
usted debe escribirla cada vez que acceda al curso. Debería haberla recibido de $a';
...
$string['enrolmentplugins'] = 'Plugins de matriculación';
...
$string['enteremail'] = 'Escriba su dirección email';
...
$string['formattopicsajax'] = 'Formato de temas - AJAX';
$string['formattopicscss'] = 'Formato de temas - CSS/No tablas';
$string['formatweeks'] = 'Formato semanal';
$string['formatweekscss'] = 'Formato semanal - CSS/No tablas';
...
$string['frontpagedescriptionhelp'] = 'Esta descripción del sitio aparecerá en la página de portada.';
...
$string['go'] = 'Ir';
$string['gotoyourserver'] = '(Vuelve a enlazar con el servidor)';
...
$string['guestskey'] = 'Permitir el acceso a invitados con contraseña';
...
$string['helpinterestslist'] = 'Escriba sus intereses separados por comas';
...
$string['helpsummaries'] = 'Sobre los resúmenes';
...
$string['hidetopicfromothers'] = 'Ocultar tema de otros';
$string['hideweekfromothers'] = 'Ocultar semana de otros';
$string['hits'] = 'Clics';
...
$string['managemetadisabled'] = 'Está desactivado porque este curso ya es un metacurso';
$string['managemetaexplan'] = '(Esto significa que las matriculaciones son heredadas de otros cursos)';
...
$string['metaalreadycourses'] = 'Cursos ya asignados';
$string['metaalreadyhascourses'] = 'Este metacurso ya tiene cursos secundarios.';
$string['metaalreadyhasenrolments'] = 'Este curso ya tiene matriculaciones normales.';
$string['metaalreadyinmeta'] = 'Este curso ya es parte de un metacurso.';
$string['metaassigncourses'] = 'Asignar cursos';
$string['metacourse'] = 'Metacurso';
$string['metanoalreadycourses'] = 'Aún no hay cursos asignados';
$string['metanopotentialcourses'] = 'No hay cursos disponibles';
...
$string['move'] = 'Mover';
$string['moveallsidetabstoblock'] = 'Volver a poner todas las pestañas en su posición de bloque';
...
$string['no'] = 'No';
$string['noblockstoaddhere'] = 'No hay bloques que pueda agregar a esta página.';
$string['nobody'] = 'Nadie';
...
$string['pageshouldredirect'] = 'Esta página debería redirigirlo automáticamente. Si no sucede nada, use por favor el enlace de continuación.';
...
$string['policyagreement'] = 'Acuerdo con las Concidiones del Sitio';
...
$string['preprocessingbackupfile'] = 'Archivo de copia de preprocesamiento';
...
$string['publicdirectorytitle'] = 'Ver lista de sitios';
$string['publicsitefileswarning'] = 'Nota: cualquiera puede ver los archivos colocados aquí';
$string['publicsitefileswarning2'] = 'Nota: Los archivos colocados aquí pueden ser accesibles a cualquiera que conozca (o pueda adivinar) la URL. Por razones de seguridad, se recomienda que las copias de seguridad se destruyan inmediatamente después de restaurarlas.';
...
$string['restoretositeadding'] = 'ATENCIÓN: Está a punto de restaurar la portada del sitio agregándole datos.';
$string['restoretositedeleting'] = 'ATENCIÓN: Está a punto de restaurar la portada del sitio eliminando datos.';
...
$string['returntooriginaluser'] = 'Retornar a $a';
...
$string['showthishelpinlanguage'] = 'Mostrar esta ayuda en: $a';
$string['showtopicfromothers'] = 'Mostrar tema de otros';
$string['showweekfromothers'] = 'Mostrar semana de otros';
$string['since'] = 'Desde';
...
$string['userviewingsettings'] = 'Perfil de $a';
