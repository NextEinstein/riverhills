<?PHP // $Id: data.php,v 1.14 2010/02/05 07:28:29 barias Exp $ 
...
$string['cannotaccesspresentsother'] = 'No se le permite acceder a ajustes previos de otros usuarios';
$string['cannotadd'] = 'No se pueden agregar entradas';
$string['cannotdeletepreset'] = 'Error al eliminar un ajuste previo';
$string['cannotrate'] = 'No se permite clasificar los elementos';
...
$string['dataadministration'] = 'Administración de la actividad de la base de datos';
$string['date'] = 'Fecha';
...
$string['guestrate'] = 'Los invitados no pueden clasificar entradas.';
...
$string['invalidratedata'] = 'Datos de clasificación enviados incorrectos';
...
$string['norating'] = 'Esta actividad no utiliza clasificaciones';
