 ...
 *
 * @author Jeff Graham
 * @version $Id: format_page.php,v 1.1 2009/12/21 00:53:33 michaelpenne Exp $
 * @package format_page
 **/

$string['accessprereq'] = 'You must access $a.';
$string['activitiesfound'] = 'No activities found or all have been added as locks.';
$string['activityaccessed'] = 'Add activity accessed';
$string['activityaccesslockx'] = 'Activity access lock for $a';
$string['activitygradeditem'] = 'Add graded activity item';
$string['activitygradelockx'] = 'Graded activity lock for <em>$a</em>';
$string['addblock'] = 'Add Block...';
$string['addexistingmodule'] = 'Add Existing Activity...';
$string['addlock'] = 'Add lock';
...
$string['displaymenu'] = 'Display in Page menu';
$string['displaytheme'] = 'Display as Top Tab';
$string['edita'] = 'Edit $a';
$string['editformvalidationfailed'] = 'Form validation failed!  Please go back and be sure to fill out all of the required fields.';
$string['editpage'] = 'Edit Page';
$string['editpagesettings'] = 'Edit Page Settings';
$string['formatpage']='Page Format';
$string['gradeprereq'] = 'You must have a grade of $a->grade or higher in $a->name.';
$string['graderangedprereq'] = 'You must have a grade between $a->lowgrade and $a->highgrade inclusive, in $a->name.';
$string['hidemenu'] = 'Hide $a from menus';
$string['hidepublish'] = 'Depublish $a';
...
$string['hidetheme'] = 'Hide $a as top tab';
...
$string['noacivitiesfound'] = 'No activites found';
$string['nochildpages'] = 'No Subpages';
$string['nogradeditemsfound'] = 'No graded activity items found or all have been added as locks.';
...
$string['notlockedalt'] = 'This page is not locked';
...
$string['pageislocked'] = 'This page has been locked and you must full fill the pre-requisites in order to unlock it.';
$string['pagename'] = 'Page Name';
$string['pagenameone'] = 'Page Name';
$string['pagenametwo'] = 'Name to Show in Page menu';
$string['pageoptions'] = 'Page Options';
$string['parent'] = 'Select Parent Page';
...
$string['prereqsmessage'] = 'This page has been locked and you must full fill the following pre-requisites: $a';
$string['previous'] = '&lt;Previous';  // pagename accessible via $a
$string['prevonlybutton'] = 'Previous Page Only';
$string['publish'] = 'Publish';
$string['removelock'] = 'Remove this lock';
...
$string['showmenu'] = 'Show $a in menus';
$string['showprereqs'] = 'Show pre-requisites';
$string['showpublish'] = 'Publish $a';
$string['showresource'] = 'more...';
$string['showtheme'] = 'Show $a as top tab';
...
$string['content:rotate'] = 'CRS Rotation';
$string['cord:default'] = 'Default';
