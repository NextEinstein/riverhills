...
function mobile_device_detect($iphone=true,$ipad=true,$android=true,$opera=true,$blackberry=true,$palm=true,$windows=true,$mobileredirect=false,$desktopredirect=false){
  ...
  switch(true){ // using a switch against the following statements which could return true is more efficient than the previous method of using if statements
    ...
    case (stripos('ipad',$user_agent) !== false); // we find the word ipad in the user agent
    ...
    case (stripos('ipod',$user_agent) !== false || stripos('iphone',$user_agent) !== false); // we find the words iphone or ipod in the user agent
    ...
    case (stripos('android',$user_agent) !== false);  // we find android in the user agent
    ...
    case (stripos('opera mini',$user_agent) !== false); // we find opera mini in the user agent
    ...
    case (stripos('blackberry',$user_agent) !== false); // we find blackberry in the user agent
  ...
  if($redirect = ($mobile_browser==true) ? $mobileredirect : $desktopredirect){
    ...
    exit;
        ...
        if($mobile_browser==''){
            ...
            return $status; // is a mobile so we are returning an array ['0'] is true ['1'] is the $status value
        }
    }
