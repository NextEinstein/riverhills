...
function moodle_optimization_install() {
    // during install lets run our portion of the cron so the user hopefully won't see a wonky site.
    moodle_optimization_cron();
