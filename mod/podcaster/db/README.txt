...
/// for demonstrative purposes and to show how the podcaster
/// iself has been upgraded.

/// For each upgrade block, the file podcaster/version.php
...
/// First example, some fields were added to the module on 20070400
    ...
    /// Define field course to be added to podcaster
    ...
    /// Define field intro to be added to podcaster
        $table = new XMLDBTable('podcaster');
    ...
    /// Define field introformat to be added to podcaster
        $table = new XMLDBTable('podcaster');
...
/// "01" in the last two digits of the version
    ...
    /// Define field timecreated to be added to podcaster
        $table = new XMLDBTable('podcaster');
    ...
    /// Define field timemodified to be added to podcaster
        $table = new XMLDBTable('podcaster');
    ...
    /// Define index course (not unique) to be added to podcaster
        $table = new XMLDBTable('podcaster');
...
/// Third example, the next day, 20070402 (with the trailing 00), some inserts were performed, related with the module
    ...
    /// Add some actions to get them properly displayed in the logs
        $rec = new stdClass;
        $rec->module = 'podcaster';
        $rec->action = 'add';
        $rec->mtable = 'podcaster';
        $rec->filed  = 'name';
